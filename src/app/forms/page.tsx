...
const AjukanFormPage: React.FC = () => {
    ...
    const formsList = [
        ...
        },
        {
            ...
            category: "hr",
            icon: "👷",
            url: "/forms/labor-request",
        },
        {
            id: 5,
            name: "Maintenance Request",
            description: "Permintaan perbaikan atau pemeliharaan",
            category: "operation",
            icon: "🔧",
            url: "/forms/maintenance",
        },
        {
            id: 6,
        ...
        },
        {
            ...
            category: "leave",
            icon: "❤️",
            url: "/forms/cuti-sakit",
        },
        {
            id: 9,
            name: "Travel Request",
            description: "Permintaan perjalanan dinas",
            category: "operation",
            icon: "✈️",
            url: "/forms/travel-request",
        },
        {
            id: 10,
        ...
        },
        {
            ...
            description: "Permintaan pelatihan atau training",
            category: "hr",
            icon: "🎓",
            url: "/forms/training-request",
        },
        {
            id: 12,
            name: "Resign Request",
